        ...
        <div>
            <div className="max-w-lg   group overflow-hidden  ">
                <div className='overflow-hidden relative group-hover:bg-black duration-300  '>
                    <Link to={`/plant/${data._id}`}><img id='box' src={image} alt="" className="group-hover:scale-150 group-hover:opacity-75 cursor-pointer duration-300 ease-in-out overflow-hidden object-cover object-center w-full rounded-t-md h-72 dark:bg-gray-500" /></Link>
                    {
